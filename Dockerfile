...
# 2. Install Flash Attention using verified pre-compiled wheel
# Using v2.5.3 with CUDA 12.2 (backward compatible with CUDA 12.1)
# This wheel is confirmed to exist and install successfully
